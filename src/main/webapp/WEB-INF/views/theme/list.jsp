...
<body>
	...
	<sec:authorize access="isAuthenticated()">
		...
		<c:if test="${not empty custom.avo }">
			...
			<div>
				...
				<a href="../notice/insertNotice"><button type="button" class="btn btn-outline-info }" style="float: left;">공지사항 작성</button></a>
			</div>
			<hr>
			<div>
				<a href="bestList"><button type="button" class="btn btn-outline-info }" style="float: right;"> 조회수 best </button></a>
	...
	<table class="table table-hover table-striped table-condensed" style="border: 1px solid;">
	    ...
	    <tbody>
	      <c:forEach var="tvo" items="${themeList }">
	        <tr>
	          <td>${tvo.themaNo }</td>
	          <td style="width: 100px; height: 100px;"><img src="display?fileName=${tvo.img }"><br><a href="detail?themeNo=${tvo.themaNo }&page=${pageMaker.criteria.page}">${tvo.themaTitle }</a></td>
